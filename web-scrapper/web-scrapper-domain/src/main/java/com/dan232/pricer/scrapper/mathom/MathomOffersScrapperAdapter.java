...
import com.dan232.pricer.scrapper.mathom.model.ScrappablePageableGridPage;
...
public class MathomOffersScrapperAdapter implements ScrapperPort {
    ...
    public List<WebProductPrice> scrapWeb() {
        ...
        try {
            while (page <= PAGE_LIMIT) {
                var doc = new ScrappablePageableGridPage(Jsoup.connect(MATHOM_URL + "&p=" + page)
