...
import com.dan232.pricer.scraper.mathom.model.ScrapableGridPage;
...
public class MathomNewGamesScraperAdapter implements ScraperPort {
    ...
    public List<WebProductPrice> scrapWeb() {
        try {
            var doc = new ScrapableGridPage(Jsoup.connect(MATHOM_URL)
