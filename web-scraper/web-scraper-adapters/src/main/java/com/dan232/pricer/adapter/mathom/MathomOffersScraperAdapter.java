...
import com.dan232.pricer.adapter.mathom.model.ScrapablePageableGridPage;
...
public final class MathomOffersScraperAdapter implements ScraperPort {

    private static final String MATHOM_URL =
            "https://mathom.es/es/2507-ofertas?n=100";
